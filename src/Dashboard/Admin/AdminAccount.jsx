...
const AdminAccount = () => {
  ...
  return (
    <>
      ...
      {error && <Error />}
      {!loading && !error && (
        <div className="lg:px-[80px] md:px-[50px] sm:px-[25px] px-[15px] w-full lg:pb-[50px] md:pb-[40px] pb-[30px] lg:pt-[20px] md:pt-[15px] pt-[12px] overflow-hidden">
              ...
              <div className="flex flex-col items-center gap-[10px]">
                ...
                <div className="w-full" onClick={() => setIsOpen(!isOpen)}>
                  <button
                    ...
                    className={`${
                      tab === "mycourse" ? "text-[#6045ff]" : "text-[#43392d]"
                    } py-[8px] px-[20px] hover:text-[#6045ff] rounded-md w-full flex items-center gap-[8px] font-bold `}
                  >
          ...
          <div className="w-full md:flex md:justify-between md:gap-[30px]">
            ...
            <div className="md:w-[75%] bg-[#f4f5f8] h-full box_shadow rounded-md md:p-[30px] p-[15px]">
              ...
              {tab === "order" && <EnrolledCourses data={data.course} />}
