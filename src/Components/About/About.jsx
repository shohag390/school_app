  ...
  return (
    <div className="md:h-[90vh] w-full md:px-[80px] md:py-0 py-[30px] px-[20px] md:flex md:justify-between md:items-center bg-[#ffffff] md:gap-[80px]">
      <div className="flex items-center justify-center md:w-1/2 gap-[15px]">
        <img
          className="md:h-[515px] h-[315px] rounded-t-full rounded-bl-full"
          src={about01}
          alt=""
        />
        <div className="flex flex-col items-center gap-[15px]">
          <img
            className="rounded-full md:h-[250px] md:w-[250px] h-[150px] w-[150px]"
            src={about02}
            alt=""
          />
          <img
            className="rounded-e-full md:h-[250px] md:w-[250px] h-[150px] w-[150px] rounded-ss-full"
            src={about03}
            alt=""
          />
        </div>
      ...
      <div className="flex flex-col items-start md:w-1/2 md:pt-0 pt-[35px]">
        ...
        <h4 className="md:font-[700] font-[600] md:text-[45px] text-[38px] md:w-[80%] md:leading-[48px] leading-[46px] md:pt-[20px] pt-[15px] md:pb-[35px] pb-[25px]">
          Oriented Learning{" "}
